...
import {OutputStatusEnum, useStargateOutput} from "@AppBuilderLib/entities/stargate/model/useStargateOutput";
...
import {IShapeDiverOutputDefinition, IShapeDiverOutputDefinitionChunk} from "../config/output";
