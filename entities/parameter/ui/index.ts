...
export {
	default as ParameterColorComponent,
...
} from "./ParameterSliderComponent";

export {
	default as ParameterStargateComponent,
	ParameterStargateComponentThemeProps,
} from "./ParameterStargateComponent";
