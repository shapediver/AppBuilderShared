...
export type UseAppBuilderActionSetParameterValuesProps = (
	| IAppBuilderActionPropsSetParameterValues
	| IAppBuilderLegacyActionPropsSetParameterValue
) & {
	namespace: string;
...
/** Logic for the "setParameterValues" action. Can be used without the action component. */
export function useAppBuilderActionSetParameterValues(
	props: UseAppBuilderActionSetParameterValuesProps,
) {
	...
	}, [parametersList, parameterValues, namespace]);
	...
	const processParameterUpdates = useCallback(
		...
		[parameters, batchParameterValueUpdate],
	);
	...
	}, [parameterValueSourcesResults, processParameterUpdates, parameters]);
