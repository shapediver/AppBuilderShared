...
export interface UseAppBuilderActionCameraProps extends IAppBuilderActionPropsCamera {
	namespace: string;
	viewportId?: string;
	disabled?: boolean;
}

/** Logic for the "camera" action. Can be used without the action component. */
export function useAppBuilderActionCamera(
	props: UseAppBuilderActionCameraProps,
) {
