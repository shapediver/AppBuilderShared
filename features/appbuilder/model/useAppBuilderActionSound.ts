...
export interface UseAppBuilderActionSoundProps {
	href: string;
	autoplay?: boolean;
	loop?: boolean;
	disabled?: boolean;
...
/** Logic for the "sound" action. Can be used without the action component. */
export function useAppBuilderActionSound(props: UseAppBuilderActionSoundProps) {
	const {href, autoplay = false, loop = false, disabled} = props;
