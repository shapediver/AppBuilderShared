...
import {IProcess, IProcessDefinition, IProcessManager, IProgress, IShapeDiverStoreProcessManager, PROCESS_STATUS} from "@AppBuilderLib/shared/config/shapediverStoreProcessManager";
