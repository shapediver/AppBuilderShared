...
export const mantineThemeOverridePropsSchema = z.object({
    focusRing: z.union([z.literal("auto"), z.literal("always"), z.literal("never")]).optional(),
    ...
    cursorType: z.union([z.literal("default"), z.literal("pointer")]).optional(),
    ...
    primaryShade: z.union([z.number(), z.object({
