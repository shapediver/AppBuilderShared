import {QUERYPARAM_CONTEXT, QUERYPARAM_MODELSTATEID, QUERYPARAM_MODELVIEWURL, QUERYPARAM_SETTINGSURL, QUERYPARAM_SLUG, QUERYPARAM_TICKET} from "@AppBuilderLib/shared/config/queryparams";
...
export function buildAppBuilderUrl(data: IAppBuilderUrlBuilderData): string {
	...
	if (slug) {
		...
		throw new Error(
			"Either settingsUrl or slug or both ticket and modelViewUrl must be provided.",
		);
	}
