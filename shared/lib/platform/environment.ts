import {QUERYPARAM_LOCALHOST_RUNNING_IN_PLATFORM, QUERYPARAM_USE_DEV_PLATFORM, QUERYPARAM_USE_SANDBOX_PLATFORM, QUERYPARAM_USE_STAGING_PLATFORM} from "@AppBuilderLib/shared/config/queryparams";
