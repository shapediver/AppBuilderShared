...
export type IParameterStore = UseBoundStore<
	StoreApi<IShapeDiverParameter<any>>
>;
...
export type IParameterStoresPerSession = {
	[namespace: string]: IParameterStores;
};
...
export interface IParameterChangesPerSession {
	[namespace: string]: IParameterChanges;
}
 ...
 */
export interface IPreExecutionHookPerSession {
	[namespace: string]: IPreExecutionHook;
}

/**
 * Selector for deciding whether a parameter should use accept/reject mode or immediate execution.
 */
export type IAcceptRejectModeSelector = (
	param: IShapeDiverParameterDefinition,
) => boolean;
...
export interface IShapeDiverStoreParameters {
	 ...
	 * @returns
	 */
	readonly registerDefaultExport: (
		namespace: string,
	 ...
	 * @returns
	 */
	readonly deregisterDefaultExport: (
		namespace: string,
		exportId: string | string[],
	) => void;
