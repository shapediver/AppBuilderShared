...
export default function AppBuilderFallbackContainerComponent({ parameters, exports, namespace }: Props) {
		...
		if (parameters.length > 0) {
			...
			tabProps.tabs.push({
				...
				children: [
					...
					<AppBuilderAgentWidgetComponent key={1} namespace={namespace} />
				]
			});
		}
		if (exports.length > 0) {
